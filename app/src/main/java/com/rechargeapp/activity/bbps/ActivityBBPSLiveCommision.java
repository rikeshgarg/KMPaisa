...
import com.rechargeapp.adapter.RechargeCommisionAdapter;
import com.rechargeapp.model.RechargeIncomeModel;
...
public class ActivityBBPSLiveCommision extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    private void StartApp() {
        ...
        new NoInternetScreen(svContext, root, ActivityBBPSLiveCommision.this);
