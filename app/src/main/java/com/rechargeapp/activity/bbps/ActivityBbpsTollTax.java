...
//        }
        if (response == 0) {
            ...
            boolean isWalletLoading = act.checkEWalletAndAddWallet(amount, "Toll", svContext,lstEditext,strOperatorCode,edRechargeAmount.getText().toString().trim(),"",customToast);
            if (!isWalletLoading) {
