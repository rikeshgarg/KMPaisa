...
import com.rechargeapp.adapter.RechargeCommisionReportHistoryAdapter;
...
public class ActivityFundTransferCommisionHistory extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    private void LoadRechargeHistory(String fromDate, String toDate) {
        ...
        callWebService(ApiInterface.FUNDTRANSFERCOMMISIONREPORTLIST, lstUploadData);
    }
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityFundTransferCommisionHistory.this);
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("Fund Transfer Commission History");
    }
    ...
    public void onWebServiceActionComplete(String result, String url) {
        ...
        if (url.contains(ApiInterface.FUNDTRANSFERCOMMISIONREPORTLIST)) {
            try {
