...
public class ViewComplainListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ViewComplainListAdapter(Context context, List<TicketListModel> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        public TextView ticketId, subject, message, type, status, datetime,tv_h_subject;
        ...
        public OriginalViewHolder(View v) {
            ...
            tv_h_subject=(TextView) v.findViewById(R.id.tv_h_subject);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.tv_h_subject.setText("Order Id: ");
...
//            }
            view.imgTicket.setVisibility(View.INVISIBLE);
            view.line2.setVisibility(View.INVISIBLE);
