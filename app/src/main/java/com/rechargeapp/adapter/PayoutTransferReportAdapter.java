...
import com.rechargeapp.model.PayoutTransferReportModel;
...
public class PayoutTransferReportAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        public TextView txtmember, txtMobile, txtname, txtifsc, txtAccountNo, txtamount, txttransasctionid, txtrrn, txtstatus, txtdate;
        public LinearLayout layAccountNo;
        ...
        public OriginalViewHolder(View v) {
            ...
            txtAccountNo = (TextView) v.findViewById(R.id.tv_acc_no);
            layAccountNo = v.findViewById(R.id.lay_acc_no);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            if (TextUtils.isEmpty(items.get(position).getStr_acc_no())) {
                view.layAccountNo.setVisibility(View.GONE);
            } else {
                view.layAccountNo.setVisibility(View.VISIBLE);
                view.txtAccountNo.setText(items.get(position).getStr_acc_no());
            }
