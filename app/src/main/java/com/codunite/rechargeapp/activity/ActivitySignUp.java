...
public class ActivitySignUp extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    private void StartApp() {
        ...
        new NoInternetScreen(svContext, root, ActivitySignUp.this);
