...
//        }
    ...
    private void StartApp() {
        ...
        new NoInternetScreen(svContext, root, ActivityMainWalletTransfer.this);
...
//        }
    ...
    public void showContactBottomSheet() {
        ...
        AppExecutors.getInstance().diskIO().execute(() -> {
            ...
            runOnUiThread(() -> mAdapter.updateData(lstContacts));
        });

        rvContactsList.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener((view1, contactModel, position) -> {
