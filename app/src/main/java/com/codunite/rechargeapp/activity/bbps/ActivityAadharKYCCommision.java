...
public class ActivityAadharKYCCommision extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    public void resumeApp() {
        ...
        callWebService(ApiInterface.GETAADHARKYCCOMMISIONLIST, lstUploadData);
    ...
    private void StartApp() {
        ...
        new NoInternetScreen(svContext, root, ActivityAadharKYCCommision.this);
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("Aadhar eKyc Charge");
    ...
    public void onWebServiceActionComplete(String result, String url) {
        if (url.contains(ApiInterface.GETAADHARKYCCOMMISIONLIST)) {
            try {
