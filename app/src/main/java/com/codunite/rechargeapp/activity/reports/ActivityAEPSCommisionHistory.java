...
import com.codunite.rechargeapp.adapter.AEPSCommisionReportHistoryAdapter;
import com.codunite.rechargeapp.adapter.RechargeCommisionReportHistoryAdapter;
import com.codunite.rechargeapp.model.AEPSCommisionReportModel;
...
public class ActivityAEPSCommisionHistory extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    private void LoadRechargeHistory(String fromDate, String toDate) {
        ...
        callWebService(ApiInterface.AEPSCOMMISIONREPORTLIST, lstUploadData);
    }
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivityAEPSCommisionHistory.this);
    ...
    private List<AEPSCommisionReportModel> lstItems = new ArrayList<>();

    @Override
    public void onWebServiceActionComplete(String result, String url) {
        System.out.println(result + ".........jsonresponse....." + url);
        if (url.contains(ApiInterface.AEPSCOMMISIONREPORTLIST)) {
            try {
                ...
                if (str_status.equalsIgnoreCase("0")) {
                    ...
                    for (int data_i = 0; data_i < ((JSONArray) data).length(); data_i++) {
                        ...
                        String str_txn_id = data_obj.getString("txnID");
                        String str_txn_type = data_obj.getString("service");
                        ...
                        lstItems.add(new AEPSCommisionReportModel(str_user_code,str_member_name, str_txn_id,str_txn_type,str_amount,str_commision_amount, str_type,str_datetime));
                    }
                }
            ...
            AEPSCommisionReportHistoryAdapter mAdapter = new AEPSCommisionReportHistoryAdapter(this, lstItems, animation_type);
            wallethistoryrv.setNestedScrollingEnabled(false);
            wallethistoryrv.setAdapter(mAdapter);
            mAdapter.setOnItemClickListener(new AEPSCommisionReportHistoryAdapter.OnItemClickListener() {
                @Override
