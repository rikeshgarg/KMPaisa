...
import com.codunite.rechargeapp.adapter.AadharKYCCommisionAdapter;
import com.codunite.rechargeapp.adapter.PancardCommisionAdapter;
...
public class ActivityPanCardCommision extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
    ...
    public void resumeApp() {
        ...
        callWebService(ApiInterface.GETUTIPANCARDCOMMISIONLIST, lstUploadData);
    ...
    private void StartApp() {
        ...
        new NoInternetScreen(svContext, root, ActivityPanCardCommision.this);
    ...
    private void loadToolBar() {
        ...
        txtHeading.setText("UTI Pancard Charge");
    ...
    public void onWebServiceActionComplete(String result, String url) {
        if (url.contains(ApiInterface.GETUTIPANCARDCOMMISIONLIST)) {
            try {
                ...
                if (str_status.equalsIgnoreCase("0")) {
                    ...
                    for (int data_i = 0; data_i < ((JSONArray) data).length(); data_i++) {
                        ...
                        String strCharge = data_obj.getString("commision");
                        String strisFlat = data_obj.getString("is_flat");
                        String strSurcharge = data_obj.getString("is_surcharge");
                        lstItems.add(new BBPSCommisionModel("","",strService, strCharge,strisFlat,strSurcharge));
                    }
                }
            ...
            PancardCommisionAdapter mAdapter = new PancardCommisionAdapter(this, lstItems, animation_type);
