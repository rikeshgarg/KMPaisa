...
public final class ActRegisterTransferBinding implements ViewBinding {
  ...
  private ActRegisterTransferBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatButton btnLoginIn, @NonNull AppCompatButton btnSignUp,
      @NonNull Button btnTransactionPassword, @NonNull EditText edtAddress,
      @NonNull EditText edtFname, @NonNull EditText edtLname, @NonNull EditText edtMobile,
      @NonNull EditText edtPincode, @NonNull EditText edtTransactionpassword,
      @NonNull TextView goback, @NonNull ConstraintLayout headlayout,
      @NonNull IncludeActionbarBinding layActionbar, @NonNull CardView layoutTransactionpassword,
      ...
      @NonNull TextView tvLogin, @NonNull TextView txtDob, @NonNull TextView txtLoginerror) {
  ...
  public static ActRegisterTransferBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btn_loginIn;
      AppCompatButton btnLoginIn = ViewBindings.findChildViewById(rootView, id);
      if (btnLoginIn == null) {
        break missingId;
      }
