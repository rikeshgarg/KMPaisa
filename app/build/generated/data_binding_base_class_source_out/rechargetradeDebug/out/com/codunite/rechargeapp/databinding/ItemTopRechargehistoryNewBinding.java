...
public final class ItemTopRechargehistoryNewBinding implements ViewBinding {
  ...
  private ItemTopRechargehistoryNewBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull AppCompatButton btnComplain, @NonNull CardView cvRecharge,
      @NonNull ImageView ivOperator, @NonNull LinearLayout llDetails, @NonNull LinearLayout llImg,
      @NonNull LinearLayout llRight, @NonNull LinearLayout lytParent, @NonNull TextView mobile,
      @NonNull TextView tvRechargeType, @NonNull TextView txtId, @NonNull TextView txtmember,
      @NonNull TextView vmMemberid, @NonNull TextView vmName, @NonNull TextView vmWallbal) {
  ...
  public static ItemTopRechargehistoryNewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTopRechargehistoryNewBinding((LinearLayout) rootView, afterBalance,
          beforeBalance, btnComplain, cvRecharge, ivOperator, llDetails, llImg, llRight, lytParent,
          mobile, tvRechargeType, txtId, txtmember, vmMemberid, vmName, vmWallbal);
    }
