...
public final class ActAepscommisionBinding implements ViewBinding {
  @NonNull
  ...
  private ActAepscommisionBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAddwallet,
      @NonNull CardView cardAddwallet, @NonNull CardView cardWallbal,
      @NonNull ConstraintLayout headlayout, @NonNull IncludeActionbarBinding layActionbar,
      @NonNull LinearLayout linearLayout, @NonNull TextView walletbal,
  ...
  @NonNull
  public static ActAepscommisionBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActAepscommisionBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.act_aepscommision, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActAepscommisionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActAepscommisionBinding((ConstraintLayout) rootView, btnAddwallet, cardAddwallet,
          cardWallbal, headlayout, binding_layActionbar, linearLayout, walletbal, wallethistoryRv);
    }
