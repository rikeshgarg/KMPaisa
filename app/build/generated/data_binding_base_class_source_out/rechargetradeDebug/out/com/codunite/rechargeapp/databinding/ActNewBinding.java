...
public final class ActNewBinding implements ViewBinding {
  @NonNull
  ...
  private ActNewBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnElectricrecharge,
      @NonNull Button btnOtpauth, @NonNull LinearLayout cardElectrical,
      @NonNull LinearLayout cardOtp, @NonNull PinView edtOtp, @NonNull EditText electricityAmount,
      ...
      @NonNull RelativeLayout layCircle, @NonNull LinearLayout layDynamicLay,
  ...
  @NonNull
  public static ActNewBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static ActNewBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.act_new, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActNewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActNewBinding((ConstraintLayout) rootView, btnElectricrecharge, btnOtpauth,
          cardElectrical, cardOtp, edtOtp, electricityAmount, headlayout, imgDrop1,
          binding_layActionbar, layBiller, layCircle, layDynamicLay, nestedScrollView,
          spinnerElectricoperatorlist, txtCurrency, txtUsername, txtViewallplans);
    }
