...
public final class ActCommisionhistoryBinding implements ViewBinding {
  ...
  private ActCommisionhistoryBinding(@NonNull LinearLayout rootView,
  ...
  public static ActCommisionhistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActCommisionhistoryBinding((LinearLayout) rootView, datePickerFrom, datePickerTo,
