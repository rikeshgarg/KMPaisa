...
public final class ActWallethistoryBinding implements ViewBinding {
  @NonNull
  ...
  private ActWallethistoryBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAddwallet,
  ...
  @NonNull
  public static ActWallethistoryBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActWallethistoryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.act_wallethistory, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActWallethistoryBinding bind(@NonNull View rootView) {
