...
public final class FragHomeBinding implements ViewBinding {
  ...
  private FragHomeBinding(@NonNull LinearLayout rootView, @NonNull FrameLayout cardAffiliate,
      ...
      @NonNull LinearLayout layEWallet, @NonNull LinearLayout layLevelIncome,
      @NonNull LinearLayout layRWallet, @NonNull LinearLayout layTotalDownline,
      @NonNull SwipeRefreshLayout layrefrsh, @NonNull LinearLayout llAddfund,
      @NonNull LinearLayout llPassbook, @NonNull LinearLayout llPay, @NonNull LinearLayout mylayout,
  ...
  public static FragHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragHomeBinding((LinearLayout) rootView, cardAffiliate, cvRecharge1, cvRecharge2,
          cvRecharge3, imageSlider, imgdrawable1, imgdrawable2, imgdrawable3, layActiveDownline,
          layDeactiveDownline, layDirectActive, layDirectDeactive, layDirectDownline,
          layDirectIncome, layEWallet, layLevelIncome, layRWallet, layTotalDownline, layrefrsh,
          llAddfund, llPassbook, llPay, mylayout, nestedScrollView, rvBbps, rvDashboard,
          ...
          txtRechargeIncome, txtTotalDownline, txtTotalIncome, viewPagerImageSlider);
    }
