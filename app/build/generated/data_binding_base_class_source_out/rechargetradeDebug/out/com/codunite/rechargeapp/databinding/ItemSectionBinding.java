...
public final class ItemSectionBinding implements ViewBinding {
  ...
  private ItemSectionBinding(@NonNull LinearLayout rootView, @NonNull TextView titleSection) {
  ...
  public static ItemSectionBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.title_section;
      TextView titleSection = ViewBindings.findChildViewById(rootView, id);
      if (titleSection == null) {
        break missingId;
      }

      return new ItemSectionBinding((LinearLayout) rootView, titleSection);
    }
