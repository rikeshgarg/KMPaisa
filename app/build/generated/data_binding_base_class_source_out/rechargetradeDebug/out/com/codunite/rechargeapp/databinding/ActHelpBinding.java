...
public final class ActHelpBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatButton submitTicket;
  ...
  private ActHelpBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnRemovepic,
      ...
      @NonNull Spinner spinnerCountrylist, @NonNull AppCompatButton submitTicket) {
  ...
  public static ActHelpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      AppCompatButton submitTicket = ViewBindings.findChildViewById(rootView, id);
