...
public final class ActBbpsallservicesBinding implements ViewBinding {
  ...
  private ActBbpsallservicesBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull Button btnOtpauth, @NonNull Button btnOtpcancel,
      @NonNull LinearLayout cardElectrical, @NonNull LinearLayout cardOtp, @NonNull EditText edtOtp,
      @NonNull EditText electricityAmount, @NonNull ConstraintLayout headlayout,
      @NonNull ImageView imgDrop1, @NonNull ImageView imgServiceoperator,
      @NonNull IncludeActionbarBinding layActionbar, @NonNull LinearLayout layBiller,
      @NonNull LinearLayout layDynamicLay, @NonNull RelativeLayout layServiceoperator,
      @NonNull RelativeLayout laySpinnerOperator, @NonNull NestedScrollView nestedScrollView,
      @NonNull TextView spinnerElectricoperatorTxt, @NonNull Spinner spinnerElectricoperatorlist,
      @NonNull Spinner spinnerServiceoperator, @NonNull TextView spinnerServiceoperatorTxt,
      @NonNull TextView tvHeading, @NonNull TextView txtCurrency, @NonNull TextView txtUsername,
