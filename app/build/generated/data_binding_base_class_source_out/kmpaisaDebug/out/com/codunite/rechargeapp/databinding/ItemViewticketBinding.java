...
public final class ItemViewticketBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvHSubject;
  ...
  private ItemViewticketBinding(@NonNull LinearLayout rootView, @NonNull TextView complaintype,
      ...
      @NonNull TextView subject, @NonNull TextView ticketid, @NonNull TextView tvHSubject) {
  ...
  public static ItemViewticketBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_h_subject;
      TextView tvHSubject = ViewBindings.findChildViewById(rootView, id);
      if (tvHSubject == null) {
        break missingId;
      }

      return new ItemViewticketBinding((LinearLayout) rootView, complaintype, datetime, imgTicket,
          layHeadChange, line2, llLine, lytParent, message, status, subject, ticketid, tvHSubject);
    }
