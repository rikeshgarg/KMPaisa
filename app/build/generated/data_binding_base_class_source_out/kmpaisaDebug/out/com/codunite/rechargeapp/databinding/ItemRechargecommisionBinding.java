...
public final class ItemRechargecommisionBinding implements ViewBinding {
  @NonNull
  ...
  private ItemRechargecommisionBinding(@NonNull LinearLayout rootView, @NonNull CardView cardview,
  ...
  @NonNull
  public static ItemRechargecommisionBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemRechargecommisionBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_rechargecommision, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemRechargecommisionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRechargecommisionBinding((LinearLayout) rootView, cardview, codeReCommision,
