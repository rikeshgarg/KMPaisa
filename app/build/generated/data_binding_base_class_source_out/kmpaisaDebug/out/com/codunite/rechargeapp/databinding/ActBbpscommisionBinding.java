...
public final class ActBbpscommisionBinding implements ViewBinding {
  @NonNull
  ...
  private ActBbpscommisionBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAddwallet,
  ...
  @NonNull
  public static ActBbpscommisionBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActBbpscommisionBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.act_bbpscommision, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActBbpscommisionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActBbpscommisionBinding((ConstraintLayout) rootView, btnAddwallet, cardAddwallet,
