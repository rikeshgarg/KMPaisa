...
public final class ActFundRequestHistoryBinding implements ViewBinding {
  @NonNull
  ...
  private ActFundRequestHistoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnAddwallet, @NonNull CardView cardWallbal, @NonNull TextView datePickerFrom,
  ...
  @NonNull
  public static ActFundRequestHistoryBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActFundRequestHistoryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.act_fund_request_history, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActFundRequestHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActFundRequestHistoryBinding((ConstraintLayout) rootView, btnAddwallet,
          cardWallbal, datePickerFrom, datePickerTo, edtKeyword, ewalletbal, filterSearch,
          headlayout, historyRv, binding_layActionbar, layFilter, layNestedscroll, linearLayout,
          rvPagination, walletbal);
    }
