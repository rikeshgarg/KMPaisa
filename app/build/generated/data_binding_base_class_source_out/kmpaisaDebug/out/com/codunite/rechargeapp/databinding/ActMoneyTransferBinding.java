...
public final class ActMoneyTransferBinding implements ViewBinding {
  ...
  @NonNull
  public static ActMoneyTransferBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActMoneyTransferBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.act_money_transfer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActMoneyTransferBinding bind(@NonNull View rootView) {
