...
public final class ActBbpslivecommisionBinding implements ViewBinding {
  @NonNull
  ...
  private ActBbpslivecommisionBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActBbpslivecommisionBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActBbpslivecommisionBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.act_bbpslivecommision, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActBbpslivecommisionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActBbpslivecommisionBinding((ConstraintLayout) rootView, btnAddwallet,
          cardAddwallet, cardWallbal, headlayout, binding_layActionbar, linearLayout, walletbal,
          wallethistoryRv);
    }
