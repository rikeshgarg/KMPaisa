...
public final class ActDmrcommisionBinding implements ViewBinding {
  @NonNull
  ...
  private ActDmrcommisionBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAddwallet,
  ...
  @NonNull
  public static ActDmrcommisionBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActDmrcommisionBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.act_dmrcommision, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActDmrcommisionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActDmrcommisionBinding((ConstraintLayout) rootView, btnAddwallet, cardAddwallet,
