...
public final class ActTopupwalletBinding implements ViewBinding {
  @NonNull
  ...
  private ActTopupwalletBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnproceedtopay,
  ...
  @NonNull
  public static ActTopupwalletBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActTopupwalletBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.act_topupwallet, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActTopupwalletBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActTopupwalletBinding((ConstraintLayout) rootView, btnproceedtopay, currentBal,
          edtenteramount, edttransid, headlayout, historyLabel, binding_layActionbar, layTopwallet,
          linearLayout, wallethistoryRv);
    }
