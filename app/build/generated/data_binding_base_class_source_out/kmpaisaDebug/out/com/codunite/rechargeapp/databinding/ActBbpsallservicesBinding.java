...
public final class ActBbpsallservicesBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView imgServiceoperator;
  ...
  @NonNull
  public final RelativeLayout laySpinnerOperator;

  @NonNull
  public final NestedScrollView nestedScrollView;

  @NonNull
  public final TextView spinnerElectricoperatorTxt;
  ...
  @NonNull
  public final TextView spinnerServiceoperatorTxt;
  ...
  private ActBbpsallservicesBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView imgServiceoperator, @NonNull IncludeActionbarBinding layActionbar,
      @NonNull LinearLayout layBiller, @NonNull LinearLayout layDynamicLay,
      @NonNull RelativeLayout layServiceoperator, @NonNull RelativeLayout laySpinnerOperator,
      @NonNull NestedScrollView nestedScrollView, @NonNull TextView spinnerElectricoperatorTxt,
      @NonNull Spinner spinnerElectricoperatorlist, @NonNull Spinner spinnerServiceoperator,
      @NonNull TextView spinnerServiceoperatorTxt, @NonNull TextView tvHeading,
    ...
    this.imgServiceoperator = imgServiceoperator;
    ...
    this.laySpinnerOperator = laySpinnerOperator;
    this.nestedScrollView = nestedScrollView;
    this.spinnerElectricoperatorTxt = spinnerElectricoperatorTxt;
    this.spinnerElectricoperatorlist = spinnerElectricoperatorlist;
    this.spinnerServiceoperator = spinnerServiceoperator;
    this.spinnerServiceoperatorTxt = spinnerServiceoperatorTxt;
  ...
  public static ActBbpsallservicesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.img_serviceoperator;
      ImageView imgServiceoperator = ViewBindings.findChildViewById(rootView, id);
      if (imgServiceoperator == null) {
        break missingId;
      }
      ...
      id = R.id.lay_spinner_operator;
      RelativeLayout laySpinnerOperator = ViewBindings.findChildViewById(rootView, id);
      if (laySpinnerOperator == null) {
        break missingId;
      }
      ...
      id = R.id.spinner_electricoperator_txt;
      TextView spinnerElectricoperatorTxt = ViewBindings.findChildViewById(rootView, id);
      if (spinnerElectricoperatorTxt == null) {
        break missingId;
      }
      ...
      id = R.id.spinner_serviceoperator_txt;
      TextView spinnerServiceoperatorTxt = ViewBindings.findChildViewById(rootView, id);
      if (spinnerServiceoperatorTxt == null) {
        break missingId;
      }
      ...
      return new ActBbpsallservicesBinding((ConstraintLayout) rootView, btnElectricrecharge,
          ...
          headlayout, imgDrop1, imgServiceoperator, binding_layActionbar, layBiller, layDynamicLay,
          layServiceoperator, laySpinnerOperator, nestedScrollView, spinnerElectricoperatorTxt,
          spinnerElectricoperatorlist, spinnerServiceoperator, spinnerServiceoperatorTxt, tvHeading,
