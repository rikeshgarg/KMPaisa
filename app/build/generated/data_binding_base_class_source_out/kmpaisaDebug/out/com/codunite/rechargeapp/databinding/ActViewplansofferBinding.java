...
public final class ActViewplansofferBinding implements ViewBinding {
  @NonNull
  ...
  private ActViewplansofferBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActViewplansofferBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActViewplansofferBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.act_viewplansoffer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActViewplansofferBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActViewplansofferBinding((ConstraintLayout) rootView, headlayout,
          binding_layActionbar);
    }
