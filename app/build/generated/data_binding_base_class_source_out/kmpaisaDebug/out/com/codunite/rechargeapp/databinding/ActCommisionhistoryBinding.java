...
public final class ActCommisionhistoryBinding implements ViewBinding {
  @NonNull
  ...
  private ActCommisionhistoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnAddwallet, @NonNull CardView cardAddwallet, @NonNull CardView cardWallbal,
      @NonNull TextView ewalletbal, @NonNull ConstraintLayout headlayout,
  ...
  @NonNull
  public static ActCommisionhistoryBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActCommisionhistoryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.act_commisionhistory, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActCommisionhistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActCommisionhistoryBinding((ConstraintLayout) rootView, btnAddwallet,
          cardAddwallet, cardWallbal, ewalletbal, headlayout, binding_layActionbar, linearLayout,
