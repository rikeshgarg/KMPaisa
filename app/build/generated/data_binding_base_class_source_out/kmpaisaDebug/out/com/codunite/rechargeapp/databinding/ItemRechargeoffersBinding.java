...
public final class ItemRechargeoffersBinding implements ViewBinding {
  @NonNull
  ...
  private ItemRechargeoffersBinding(@NonNull LinearLayout rootView, @NonNull CardView cardview,
      @NonNull ImageView imgRuppeSymbol, @NonNull LinearLayout lytParent,
      @NonNull TextView offerPrice, @NonNull TextView offerdesc) {
  ...
  @NonNull
  public static ItemRechargeoffersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemRechargeoffersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_rechargeoffers, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemRechargeoffersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRechargeoffersBinding((LinearLayout) rootView, cardview, imgRuppeSymbol,
          lytParent, offerPrice, offerdesc);
    }
